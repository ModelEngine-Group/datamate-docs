...
{{< blocks/cover title="DataMate — All-in-one Data Processing Platform" image_anchor="top" height="full" >}}
<a class="btn btn-lg btn-primary me-3 mb-4" href="/datamate-docs/en/docs/">
Learn More <i class="fas fa-arrow-alt-circle-right ms-2"></i>
</a>
<a class="btn btn-lg btn-secondary me-3 mb-4" href="https://github.com/ModelEngine-Group/DataMate">
Deploy Now <i class="fab fa-github ms-2 "></i>
</a>
<p class="lead mt-5">Deploy DataMate in minutes, without complex configuration, and start using it right away!</p>
...
{{% blocks/feature icon="fa-database" title="End-to-end data governance" %}}
...
{{% blocks/feature icon="fab fa-github" title="Open-source and extensible" url="https://github.com/ModelEngine-Group/DataMate" %}}
...
{{% blocks/feature icon="fab fa-weixin" title="Follow the technical public account" url="https://mp.weixin.qq.com/s/isymVYr_P8m0MY79MAyn_A" %}}
Get exclusive deployment guides, data processing best practices, and real-time interaction with industry experts.
Unlock new features and scene solutions for large model data processing for the first time!
{{% /blocks/feature %}}
...
{{% blocks/feature icon="fa-brain" title="Intelligent data augmentation" %}}
...
{{% blocks/feature icon="fa-shield-halved" title="Enterprise-level security assurance" %}}
...
{{% blocks/feature icon="fa-rocket" title="Lightweight and quick to get started" %}}
